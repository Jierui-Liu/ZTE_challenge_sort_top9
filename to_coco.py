...
# root_test='/home/liujierui/proj/Dataset/A-data'
root_test='/home/liujierui/proj/Dataset/B-data'
root=dirname(realpath(__file__))

out_name=join(root,'track_A.json')
with open(out_name,'r') as load_f:
    load_dict = json.load(load_f)
cates_dict=load_dict['categories']
json_out={}

json_out['images']=[]
json_out['categories']=cates_dict
# dataset='A-data'
dataset='B-data'
id=0
...
out_name=join(root,'track_B.json')
