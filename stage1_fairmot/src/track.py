...
def main(opt, data_root='/data/MOT16/train', det_root=None, seqs=('MOT16-05',), exp_name='demo',
    ...
    for seq in seqs:
        ...
        dataloader = datasets.LoadImages(osp.join(data_root, seq, 'img1'), opt.img_size)#把img1去掉
...
if __name__ == '__main__':
    ...
    opt = opts().init()
    # jr
    exp_name='A-track_all_dla34_score0.3_nms0.3_conf0.5'
    opt.test_mot17=True
    opt.load_model="/home/liujierui/proj/FairMOT-master/models/all_dla34.pth" 
    opt.conf_thres =0.5
    opt.nms_thres =0.3
    opt.det_thres=0.3
    opt.vis_thresh=0.2
